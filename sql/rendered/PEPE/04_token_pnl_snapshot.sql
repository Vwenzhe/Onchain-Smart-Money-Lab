with token_config as (
  select
    'PEPE' as token_symbol,
    'Pepe' as token_name,
    'ethereum' as chain_name,
    lower('0x6982508145454ce325ddbe47a25d4ec3d2311933') as contract_address,
    lower('0x6982508145454ce325ddbe47a25d4ec3d2311933') as price_contract_address,
    45 as lookback_days,
